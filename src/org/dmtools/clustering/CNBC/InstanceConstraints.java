...
import org.dmtools.clustering.NBC.required.ISpatialObject;
...
public class InstanceConstraints {
    ...
    {
    	CNBCRTreePoint r0 = new CNBCRTreePoint(p0, CDMCluster.UNCLASSIFIED);
    	CNBCRTreePoint r1 = new CNBCRTreePoint(p1, CDMCluster.UNCLASSIFIED);
    	if (mustLink) {
