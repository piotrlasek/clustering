...
public class CNBCRTree implements IClusteringAlgorithm {
    ...
    public void run() {
    	...
    	ic.add(new double[]{457.0, 334.0}, new double[]{467.0, 340.0}, false);
    	ic.add(new double[]{467.0, 340.0}, new double[]{475.0, 348.0}, false);
    	ic.add(new double[]{475.0, 348.0}, new double[]{478.0, 356.0}, false);
    	
    	ic.add(new double[]{106.0, 108.0}, new double[]{455.0, 108.0}, true);
    	ic.add(new double[]{106.0, 108.0}, new double[]{423.0, 367.0}, true);
